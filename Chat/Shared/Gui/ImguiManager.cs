...
namespace Shared.Gui
{
    ...
    public class ImguiManager : IDisposable
    {
        ...
        /// </summary>
        public ImguiManager(GraphicsDevice gd, OutputDescription outputDescription, int width, int height)
        {
            _gd = gd;
            _windowWidth = width;
        ...
        {
            Assembly assembly = typeof(ImguiManager).Assembly;
        ...
        /// </summary>
        public void SubmitUi(GraphicsDevice gd, CommandList cl)
        {
            if (_isFrameBegin)
            {
                _isFrameBegin = false;
        ...
        /// </summary>
        public void OnFrameBegin(float deltaSeconds, InputSnapshot snapshot)
        {
            if (_isFrameBegin)
            {
                ImGui.Render();
