...
namespace Shared.Protocol
{
    public sealed class CSPacketProcessor : PacketProcessorBase
    {
        ...
        private void ParseAndHandleBody(CSPacketHeader header, ArraySegment<byte> body)
        {
            ...
            {
                case CSPacketProtocol.CS_Ping: ParseAndHandle_CS_Pong_NTF(body); break;
                case CSPacketProtocol.CS_Login: ParseAndHandle_CS_Login_REQ(body); break;
                case CSPacketProtocol.CS_CreateAccount: ParseAndHandle_CS_CreateAccount_REQ(body); break;
            }
        }
